...
{   
    ...
    //Arithematic<int> iobj(11, 10);        Static Allocation
    ...
    //Arithematic<double> dobj(11.7443, 10.783463);  Static Allocation

    Arithematic<double> *dobj = new Arithematic<double>(11.7443,10.783463);
